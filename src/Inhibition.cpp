#include <pedxing.h>
arma::mat rInhibition_internal(unsigned n, arma::vec par, arma::vec I, arma::vec x0,
                        unsigned maxiter, bool nonlinear, bool random, bool debug);
  
//' @export
// [[Rcpp::export]]
Rcpp::S4 rInhibition(unsigned n, arma::vec par, arma::vec I, arma::vec x0,
               unsigned maxiter, bool nonlinear, bool random, bool debug) {
  // Prepare the process ---------
...
//' @export
// [[Rcpp::export]]
arma::field<arma::vec> dInhibition(arma::vec RT, arma::vec R,
    unsigned nsim, arma::vec par, arma::vec I, arma::vec x0,
    unsigned maxiter, bool nonlinear, bool random, bool debug) {
  
 unsigned nacc = I.n_elem;
 arma::mat samples = rInhibition_internal(nsim, par, I, x0, maxiter, 
                                          nonlinear, random);
